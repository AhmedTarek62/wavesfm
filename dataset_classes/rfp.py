...
class RFPDataset(H5IQDataset):
    """HDF5-backed RF fingerprinting dataset produced by preprocess_rfp.py."""

    def __init__(self, h5_path: str | Path, return_meta: bool = False):
        self.return_meta = bool(return_meta)
        super().__init__(h5_path, sample_key="sample", label_key="label", meta_keys=("source_file", "start", "sample_rate", "center_freq"))
