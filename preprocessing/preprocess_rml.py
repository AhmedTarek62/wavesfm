...
def parse_args():
    p = argparse.ArgumentParser(description="Preprocess RML dataset into a single HDF5 file.")
    p.add_argument("--data-path", required=True, help="Root of RML files (as expected by dataset_classes.RML).")
    p.add_argument("--output", required=True, help="Destination HDF5 path (e.g., data/rml_train.h5).")
...
def main():
    ...
    print(f"Wrote RML HDF5 to {args.output}")
